...
Twarz charakteryzowana jest przez zbiór wartości kątów, odległości czy też pól wyznaczonych w oparciu o charakterystyczne punkty na obrazie. Badane są między innymi:
\begin{itemize}
